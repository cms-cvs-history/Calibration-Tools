#ifndef RecoAlgos_SelectorWithEventSetup_h
#define RecoAlgos_SelectorWithEventSetup_h
/** \class SelectorWithEventSetup
 *
 ...
 *
 * $Id: SelectorWithEventSetup.h,v 1.2 2008/01/16 14:59:03 govoni Exp $
 *
 */
...
template<typename Selector, 
	 ...
	 >
class SelectorWithEventSetup : public Base {
public:
  /// constructor 
  explicit SelectorWithEventSetup( const edm::ParameterSet & cfg ) :
    Base( cfg ),
  ...
  /// destructor
  virtual ~SelectorWithEventSetup() { }
